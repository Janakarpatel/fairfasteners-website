export default function HomeValueSection() {
  ...
  return (
    <section className="relative flex min-h-screen flex-col bg-transparent font-sans text-white">
      <div className="relative z-10 flex min-h-0 flex-1 flex-col">
        <div className="max-w-5xl shrink-0 px-6 py-8 md:px-8 lg:px-10">
          <h2 className="mt-8 text-3xl font-normal leading-tighter tracking-tight text-white md:mt-10 md:text-4xl lg:text-5xl">
        ...
        >
          {columns.map(({ title, body }, i) => (
            ...
            >
              <div
                className="pointer-events-none absolute inset-0 origin-right scale-x-0 bg-white/10 transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-x-100 motion-reduce:duration-0 motion-reduce:group-hover:scale-x-100"
                aria-hidden
              />
              <div className="relative z-10 flex min-h-0 flex-col px-6 py-12 md:py-14 lg:px-10">
                <h3 className="font-jetbrains text-sm font-normal uppercase tracking-normal text-white/70 transition-colors duration-300 ease-out group-hover:text-white motion-reduce:transition-colors">
                  0{i + 1}. {title}
                </h3>
                <p className="mt-6 text-[0.9375rem] leading-snug text-white/75 transition-colors duration-300 ease-out group-hover:text-white/90 md:text-base md:leading-relaxed motion-reduce:transition-colors">
                  {body}
                </p>
              </div>
            </div>
